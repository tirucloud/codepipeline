...
export const metadata: Metadata = {
  title: "Cloud Engineering Article | Joseph Cloud Labs Blog",
  description: "In-depth cloud engineering articles, tutorials, and insights from Joseph Cloud Labs (JCL). Learn best practices, tips, and strategies for AWS, DevOps, and more.",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  How to Build a Scalable Serverless App on AWS
                </h1>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    This article walks you through building a scalable serverless application on AWS using Lambda, API Gateway, and DynamoDB. <br /><br />
                    <strong>Main Content:</strong> <br />
                    Step-by-step instructions, code samples, and best practices for deploying, monitoring, and scaling your serverless workloads. <br /><br />
                    <strong>Conclusion:</strong> <br />
                    Key takeaways, further resources, and how JCL can help you succeed in your cloud journey.
                  </p>
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-sm bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  ...
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                    <RelatedPost
                      title="Cost Optimization Strategies in the Cloud"
